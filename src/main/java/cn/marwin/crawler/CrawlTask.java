...
public class CrawlTask extends TimerTask {
    ...
    public void word() throws IOException {
        ...
        String filePath1 = "/Users/kong/Desktop/微博舆论监控系统/src/main/java/cn/marwin/classifier/neg.txt";
        String filePath2 = "/Users/kong/Desktop/微博舆论监控系统/src/main/resources/word/wordcloud.png";
        final List<WordFrequency> wordFrequencies = frequencyAnalyzer.load(filePath1);
...
//        wordCloud.setBackground(new PixelBoundryBackground("D:\\lufei.jpg"));
        ...
        wordCloud.writeToFile(filePath2);
//        wordCloud.writeToFile("/Users/kong/Desktop/pubsenti-finder/src/main/resources/word/wordcloud1.png");
    ...
    public void word1() throws IOException {
        ...
        frequencyAnalyzer.setMinWordLength(2);
        //引入中文解析器
        String filePath3 = "/Users/kong/Desktop/微博舆论监控系统/src/main/java/cn/marwin/classifier/pos.txt";
        frequencyAnalyzer.setWordTokenizer(new ChineseWordTokenizer());
        final List<WordFrequency> wordFrequencies = frequencyAnalyzer.load(filePath3);
        Dimension dimension = new Dimension(520, 520);
        WordCloud wordCloud = new WordCloud(dimension, CollisionMode.RECTANGLE);
        wordCloud.setPadding(0);
        java.awt.Font font = new java.awt.Font("STSong-Light", 2, 40);
